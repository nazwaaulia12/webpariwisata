...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('import/assets/css/fontawesome.css')}}">
    <link rel="stylesheet" href="{{ asset('import/assets/css/templatemo-woox-travel.css')}}">
    <link rel="stylesheet" href="{{ asset('import/assets/css/owl.css')}}">
...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.html" class="logo">
                        <img src="{{ asset('import/assets/images/logo.png')}}" alt="">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="/home">Home</a></li>
                        <li><a href="about1" class="active">About</a></li>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="content">
            ...
            <p>Kepulauan Karibia adalah sekelompok pulau yang terdapat di Laut Karibia. Pulau-pulau ini terbentang menuju selatan dari bawah Florida ke barat laut Venezuela di Amerika Selatan. Paling tidak terdiri dari 7000 pulau, pulau kecil, karang, dan caye.</p>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="{{ asset('import/assets/images/cities-01.jpg')}}" alt="">
                    <h4>Havana</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="{{ asset('import/assets/images/cities-02.jpg')}}" alt="">
                    <h4>Kingston</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="{{ asset('import/assets/images/cities-03.jpg')}}" alt="">
                    <h4>George Town</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="{{ asset('import/assets/images/cities-04.jpg')}}" alt="">
                    <h4>Santo Domingo</h4>
                  </div>
                </div>
                <div class="item">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-weekly-offers owl-carousel">
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('import/assets/images/offers-01.jpg')}}" alt="">
                <div class="text">
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('import/assets/images/offers-02.jpg')}}" alt="">
                <div class="text">
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('import/assets/images/offers-03.jpg')}}" alt="">
                <div class="text">
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('import/assets/images/offers-04.jpg')}}" alt="">
                <div class="text">
                  <h4>Havana<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  <h6>$420<br><span>/person</span></h6>
                  <div class="line-dec"></div>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="{{ asset('import/assets/images/about-left-image.jpg')}}" alt="">
          </div>
        </div>
        <div class="col-lg-6">
  ...
  <script src="{{ asset('import/assets/vendor/bootstrap/js/bootstrap.min.js')}}"></script>

  <script src="{{ asset('import/assets/js/isotope.min.js')}}"></script>
  <script src="{{ asset('import/assets/js/owl-carousel.js')}}"></script>
  <script src="{{ asset('import/assets/js/wow.js')}}"></script>
  <script src="{{ asset('import/assets/js/tabs.js')}}"></script>
  <script src="{{ asset('import/assets/js/popup.js')}}"></script>
