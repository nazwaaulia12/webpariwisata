...
<html lang="en">
  ...
  <head>
    ...
    <title>Wellcome To NazwaTour</title>
        ...
        <div id="top-banner-1" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h1>NAZWA TRAVEL</h1>
              <h2>Take a Glimpse Into a Beautiful Country with Nazwa Tour&Travel</h2>
              <h1>Caribbean</h1>
              <div class="border-button"><a href="login">Login Here</a></div>
            </div>
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
                ...
                <div class="item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="{{ asset('import/assets/images/country-01.jpg')}}" alt="">
                      </div>
                    </div>
              ...
              <div class="col-lg-12">
                <div class="item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="{{ asset('import/assets/images/country-02.jpg')}}" alt="">
                      </div>
                    </div>
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
              ...
              <div class="col-lg-12">
                <div class="item last-item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="{{ asset('import/assets/images/country-03.jpg')}}" alt="">
                      </div>
                    </div>
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
