...
<div class="row">
    <div class="col-12">
        <div class="card overflow-scroll">
            <div class="card-body">
                <a href="/exportpdf1" class="btn btn-primary mb-2">
                    Export
                </a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td>
                                ...
                                <a href="{{route('paket_wisata.destroy', $pw)}}" onclick="notificationBeforeDelete(event, this, <?php echo $key+1; ?>)" class="btn btn-danger btn-xs">
                                    Delete
                                </a>
                            </td> -->
                        </tr>
