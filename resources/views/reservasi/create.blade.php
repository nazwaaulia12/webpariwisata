...
@error('tanggal_reservasi_wisata') is-invalid @enderror" id="tanggal_reservasi_wisata"
                            ...
                            value="{{old('tanggal_reservasi_wisata')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control
@error('harga') is-invalid @enderror" id="harga" placeholder="Masukan Harga" name="harga" value="{{old('harga')}}" onchange="uang()">
...
@error('jumlah_peserta') is-invalid @enderror" id="jumlah_peserta" placeholder="Masukan Jumlah Peserta"
                            name="jumlah_peserta" value="{{old('jumlah_peserta')}}" onchange="uang()">
...
btn-default">
    ...
    <!-- fitur untuk menghitung total reservasi -->
    <script>
        function uang(){
            ...
            document.getEelementById('total_bayar').value= total;
            document.getEelementById('nilai_diskon').value= perhitungan_diskon;
